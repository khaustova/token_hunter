        ...
        for token_data in tokens_data:
            ...
            if pnl >= TAKE_PROFIT or pnl <= STOP_LOSS:
                ...
                Transaction.objects.filter(token_address=token_address).update(
                    ...
                    selling_transactions_buys_m5=token_data["txns"]["m5"]["buys"],
                    selling_transactions_sells_m5=token_data["txns"]["m5"]["sells"],
                    selling_transactions_buys_h1=token_data["txns"]["h1"]["buys"],
                    selling_transactions_sells_h1=token_data["txns"]["h1"]["buys"],
